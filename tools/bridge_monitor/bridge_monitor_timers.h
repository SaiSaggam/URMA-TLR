...
#ifndef __BRIDGE_MONITOR_TIMERS_H__
#define __BRIDGE_MONITOR_TIMERS_H__
...
void bridge_timer_init(bridge_timer_info_st * timer_info,
                              timer_context_st * const timer_context,
                              void (*timer_callback)(void * arg),
                              void * const arg);
void bridge_timer_start(bridge_timer_info_st * timer_info, size_t millisecs);
void bridge_timer_start(bridge_timer_info_st * timer_info, size_t millisecs);
void bridge_timer_stop(bridge_timer_info_st * timer_info);
#endif

#endif /* __BRIDGE_MONITOR_TIMERS_H__ */
