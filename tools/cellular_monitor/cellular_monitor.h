...
#ifndef __CELLULAR_MONITOR_H__
#define __CELLULAR_MONITOR_H__
...
void monitor_cellular_led(int const fd, cellular_context_t * context);

#endif /* __CELLULAR_MONITOR_H__ */
