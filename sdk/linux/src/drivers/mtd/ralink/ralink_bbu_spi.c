...
static struct mtd_partition rt2880_partitions[] = {
         ...
         #ifdef CONFIG_MYDLINK
         , {
                 name:           "MyDLink", /* mtdblock4 */
                 size:           FLASHMAP_MYDLINK_SIZE,
                 offset:         FLASHMAP_MYDLINK_OFFSET,
         }
         #endif
         ...
         #endif
         #ifdef CONFIG_ROOTFS_IN_FLASH_NO_PADDING       //not use in AMIT
         , {
                 name:           "Kernel_RootFS",
                 size:           MTD_KERN_PART_SIZE + MTD_ROOTFS_PART_SIZE,
                 offset:         MTD_BOOT_PART_SIZE + MTD_CONFIG_PART_SIZE + MTD_FACTORY_PART_SIZE,
         ...
         , {
                 name:           "UI", /* mtdblock4 */
                 size:           FLASHMAP_UI_SIZE,
                 offset:         FLASHMAP_UI_OFFSET,
         }
         #ifdef CONFIG_UI_LANGUAGE
         , {
                 name:           "LANG", /* mtdblock5 */
                 size:           FLASHMAP_UI_LANG_SIZE,
                 offset:         FLASHMAP_UI_LANG_OFFSET,
         }
         #endif
         , {
...
#if defined(CONFIG_FLASH_MAP_32MB)
        }, {
                name:           "ODM",
...
static struct chip_info chips_data [] = {
	...
	{ "EN25Q128",		0x1c, 0x30180000, 64 * 1024, 256, 0 }, //16M
	{ "EN25QH128A",		0x1c, 0x70180000, 64 * 1024, 256, 0 }, //16M
	{ "EN25QH256",		0x1c, 0x70190000, 64 * 1024, 512, 0 }, //32M	
