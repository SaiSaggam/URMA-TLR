...
#define OPTION_PRODUCT_GSGI0335_MODEM   0x8300
...
#define HUAWEI_PRODUCT_ME909u			0x1573
...
static const struct usb_device_id option_ids[] = {
	...
	{ USB_DEVICE(OPTION_VENDOR_ID, OPTION_PRODUCT_GTM380_MODEM) },
 	{ USB_DEVICE(OPTION_VENDOR_ID, OPTION_PRODUCT_GSGI0335_MODEM) }, 
	...
	{ USB_DEVICE(HUAWEI_VENDOR_ID, HUAWEI_PRODUCT_ME909u) },
	...
	{ USB_DEVICE(0x1782, 0x3d01) },	//Lenovo TD-HSDPA
	{ USB_DEVICE(0x1e0e, 0x9000) }, //Prolink PHS100
	{ USB_DEVICE(0x1e0e, 0x9200) }, //A-Link 3G modem
	{ USB_DEVICE(0x05c6, 0x9000) }, //Haier WM100
	{ USB_DEVICE(0x1d09, 0x0ff1) },	//MLW SU-7000
	{ USB_DEVICE(0x1c15, 0x1002) },	//TLW 3G
	{ USB_DEVICE(0x1c15, 0x1003) },	//TLW 3G
	{ USB_DEVICE(0x1199, 0x6850) },	//AC880
	{ USB_DEVICE(0x1199, 0x6851) },	//AC881
	{ USB_DEVICE(0x1199, 0x6852) },	//AC880E
	{ USB_DEVICE(0x1199, 0x6853) },	//AC881E
	{ USB_DEVICE(0x1199, 0x6855) },	//AC880U
	{ USB_DEVICE(0x1199, 0x6856) },	//AC881U
	{ USB_DEVICE(0x1199, 0x683C) },	//Sierra Wireless MC8790V
	{ USB_DEVICE(0x1199, 0x6890) },	//Sierra Wireless AC501 & Compass 801
	{ USB_DEVICE(0x0408, 0xea05) },	//3.75G¼s¹F3G Module
	{ USB_DEVICE(0x0408, 0xea06) },	//3.5G¼s¹F3G Module
	{ USB_DEVICE(0x0421, 0x060d) },	//Nokia CS-10
	{ USB_DEVICE(0x0421, 0x0611) },	//Nokia CS-15
	{ USB_DEVICE(0x0421, 0x0624) },	//Nokia CS-17
	{ USB_DEVICE(0x2001, 0x7d00) }, //D-Link DWM-156(MTK2)
    { USB_DEVICE(0x2020, 0x2000) }, //MTK P300A Module
	{ USB_INTERFACE_INFO(0xff,0xff,0xff) }, //for general unspecified device
	{ USB_INTERFACE_INFO(0xff,0x01,0xff) }, //for general unspecified device
	{ USB_INTERFACE_INFO(0xff,0xff,0x00) }, //for general unspecified device
	{ USB_INTERFACE_INFO(0xff,0x02,0x01) }, //for general unspecified device //D-Link DWM-158/157 MTK Solution
	{ USB_INTERFACE_INFO(0xff,0x00,0x00) }, //for general unspecified device //D-Link DWM-158/157 MTK Solution
	{ } /* Terminating entry */
};
