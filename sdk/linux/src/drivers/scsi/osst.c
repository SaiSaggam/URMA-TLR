/*
  ...
  $Header: //WIFI_SOC/TRUNK/RT288x_SDK/source/linux-2.6.36.x/drivers/scsi/osst.c#1 $
...
static const char * cvsid = "$Id: //WIFI_SOC/TRUNK/RT288x_SDK/source/linux-2.6.36.x/drivers/scsi/osst.c#1 $";
