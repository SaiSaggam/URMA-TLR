...
static inline int ethtool_noop3(struct net_device *dev, struct ethtool_perm_addr *addr, u32 data) { return 0; }
static inline int ethtool_noop4(struct net_device *dev, u32 data, u32 supported) { return 0; }
static inline void ethtool_noop5(struct net_device *dev) { return; }
#define ethtool_op_get_link ethtool_noop1
#define ethtool_op_get_rx_csum ethtool_noop1
...
#define ethtool_op_set_tx_ipv6_csum ethtool_noop2
...
#define ethtool_op_set_flags ethtool_noop4
#define ethtool_ntuple_flush ethtool_noop5
#endif
