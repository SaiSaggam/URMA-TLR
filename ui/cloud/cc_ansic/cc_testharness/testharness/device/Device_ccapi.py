...
# ***************************************************************************
#
# Cloud Connector test framework - Device CCAPI class
#
...
class Device_ccapi(Device.Device):
    ...
    def __init__(self):
        ...
        super(Device_ccapi, self).__init__()

        #*************** Environment
        self.identifier = "Device_ccapi"

        #*************** Logging
        self.logger = logging.getLogger('cc.device.ccapi')
    ...
    def run(self):
        ...
        self.loggerExecution.info("Start Device for Cloud Connector for CCAPI from: '%s'" % self.sourceProjectPath)
        ...
        # A) Execute Cloud Connector from the python execution path
        #self.cloudConnectorProcess = pexpect.spawn(os.path.join(self.sourceProjectPath,"ccapi"))
        # B) Execute Cloud Connector from the application folder path
        self.cloudConnectorProcess = pexpect.spawn(os.path.join(self.sourceProjectPath,"ccapi"), cwd=self.sourceProjectPath)
