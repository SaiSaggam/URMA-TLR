...
# Copyright: (c) 2001 by Isaac Barona Martinez
# Licence:   LGPL
#
...
class SerialPort:
    ...
    def __init__(self, dev, timeout=None, speed=None, mode='232', params=None):
        ...
        'params' is a list that specifies properties of the serial communication.
        ...
        try:
            try:
                ...
                self.__handle = CreateFile("\\\\.\%s" % dev,
                                  win32con.GENERIC_READ|win32con.GENERIC_WRITE,
                                  0, # exclusive access
                                  None, # no security
                                  win32con.OPEN_EXISTING,
    ...
    def fileno(self):
        ...
        This information can be used for example with the select function.
        """
