...
GLOBAL_BAD_NAME=GLOBAL_DESCRIPTION_ERROR
...
# defined in connector_config.h the generator doesn't
# Precompile the C code!
ELEMENT_MAX_GREATER_MAX_CONTENT=ELEMENT_NO_ERROR
ELEMENT_NO_DESCRIPTION=ELEMENT_DESCRIPTION_ERROR
ELEMENT_MISSING_DESCRIPTION=ELEMENT_DESCRIPTION_ERROR
ELEMENT_BAD_DESCRIPTION=ELEMENT_DESCRIPTION_ERROR
ELEMENT_BAD_NAME=ELEMENT_DESCRIPTION_ERROR
ELEMENT_INVALID_ACCESS_READ=ELEMENT_INVALID_ACCESS_TYPE
ELEMENT_MISSING_ACCESS=ELEMENT_INVALID_ACCESS_TYPE
ELEMENT_BAD_HELP_DESCRIPTION=ELEMENT_INVALID_ELEMENT_TYPE
ELEMENT_NO_TYPE=ELEMENT_INVALID_ELEMENT_TYPE
ELEMENT_BAD_TYPE=ELEMENT_INVALID_ELEMENT_TYPE
ELEMENT_MISSING_TYPE=ELEMENT_INVALID_ELEMENT_TYPE
ELEMENT_NO_NAME=INVALID_CHARACTER
ELEMENT_BAD_UNIT=ELEMENT_NO_UNIT
...
def getElementTests():
    ...
    temps=[{'test':Template('element aname "A Description" type $type access read_write'),
           ...
           {'test':Template('element aname "A Description" type $type access read_write units "aunit"'),
            'error':ELEMENT_NO_ERROR,
            'minmax_test':False,
            'description':Template('element_${type}_no_error_with_unit')},
           {'test':Template('element aname "A Description" type $type access read_write units'),
            'error':ELEMENT_NO_UNIT,
            'minmax_test':False,
            'description':Template('element_${type}_no_unit')},
           {'test':Template('element aname "A Description" type $type access read_write units 12345 "Help Description"'),
           ...
           {'test':Template('element aname "A Description" "help_description" type $type $mm_pass access read_write units "aunit"'),
            'error':ELEMENT_NO_ERROR,
            'minmax_test':True,
