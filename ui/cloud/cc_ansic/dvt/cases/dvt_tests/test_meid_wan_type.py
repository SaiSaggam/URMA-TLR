...
impl = getDOMImplementation()
class MEIDWanTypeTestCase(ic_testcase.TestCase):  

    def test_meid_target(self):
        """ Verifies that the [wan_type] device request for MEID wan type. """
        self.send_device_request("wan_type", meid_wan_type)
