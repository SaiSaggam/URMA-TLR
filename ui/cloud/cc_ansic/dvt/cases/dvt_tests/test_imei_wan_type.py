...
impl = getDOMImplementation()
class IMEIWanTypeTestCase(ic_testcase.TestCase):  

    def test_imei_target(self):
        """ Verifies that the [wan_type] device request for IMEI wan type. """
        self.send_device_request("wan_type", imei_wan_type)
