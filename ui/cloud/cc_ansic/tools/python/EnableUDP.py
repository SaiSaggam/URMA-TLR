...
# ***************************************************************************
# EnableUDP.py
# Enable UDP transport for a device-id in Device Cloud using web Services.
# ---------------------------------------------------------------------------------------------------
# Usage: EnableUDP.py <Username> <Password> <Device Cloud URL> <Device ID> <EnableUDP(true or false)>
# ---------------------------------------------------------------------------------------------------
import httplib
import base64
import sys
...
def Usage():
    print 'Usage: EnableUDP.py <Username> <Password> <Device Cloud URL> <Device ID> <EnableUDP(true or false)>'
    print '    Enable UDP transport for a device-id in Device Cloud using web Services'
    print '    where:'
...
def modifyDeviceInCloudServer(username, password, cloud_url, deviceID, EnableUDP):
    ...
    message = '''<?xml version="1.0" ?>
                <DeviceCore>
                    ...
                    <dpUdpSmEnabled>%s</dpUdpSmEnabled>
                </DeviceCore>'''
    ...
    print '\nQuery to enable/disable UDP transport for device...'
