...
class FileSystemDvtTestCase(cc_testcase.TestCase):
    ...
    def test_01_put_file_return_busy(self):
        """ Sends put_file request to upload a file, several times the Connector shows a "busy" message and then continues the execution normally.
        Verifies if the returned response is the expected.
        """

        filePath = os.path.join(self.tempPath, "test_01_put_file_return_busy.txt")
        fileData = "payload"
    ...
    def test_02_put_file_error_permission_denied(self):
        """ Sends put_file request to simulate a permission denied error.
        Verifies if the returned response is the expected.
        """

        self.sendPutRequestAndVerifyErrorResponse( "test_02_put_file_error_permission_denied.txt", "Permission denied")



    def test_03_put_file_error_invalid_parameter(self):
        """ Sends put_file request to simulate an invalid parameter error.
        Verifies if the returned response is the expected.
        """

        self.sendPutRequestAndVerifyErrorResponse( "test_03_put_file_error_invalid_parameter.txt", "Invalid argument")



    def test_04_put_file_error_out_of_memory(self):
        """ Sends put_file request to simulate an out of memory error.
        Verifies if the returned response is the expected.
        """

        self.sendPutRequestAndVerifyErrorResponse( "test_04_put_file_error_out_of_memory.txt", "Cannot allocate memory")



    def test_05_put_file_error_path_not_found(self):
        """ Sends put_file request to simulate a path not found error.
        Verifies if the returned response is the expected.
        """

        self.sendPutRequestAndVerifyErrorResponse( "test_05_put_file_error_path_not_found.txt", "No such file or directory")



    def test_06_put_file_error_insufficient_storage_space(self):
        """ Sends put_file request to simulate an insufficient storage space left error.
        Verifies if the returned response is the expected.
        """

        self.sendPutRequestAndVerifyErrorResponse( "test_06_put_file_error_insufficient_storage_space.txt", "No space left on device")



    def test_07_put_file_error_unspecified(self):
        """ Sends put_file request to simulate an unknown error.
        Verifies if the returned response is the expected.
        """

        self.sendPutRequestAndVerifyErrorResponse( "test_07_put_file_error_unspecified.txt", "Unspecified error")



    def test_08_put_file_error_timeout(self):
        """ Sends put_file request to simulate a timeout error.
        Verifies if the returned response is the expected.
        """

        self.sendPutRequestAndVerifyErrorResponse( "test_08_put_file_error_timeout.txt", "Connection timed out")
    ...
    def sendPutRequestAndVerifyErrorResponse(self, filename, expectedResponse):
