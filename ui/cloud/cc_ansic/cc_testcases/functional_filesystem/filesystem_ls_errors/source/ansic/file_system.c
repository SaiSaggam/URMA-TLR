...
/******** End of Modifications for testing ls command ********/
...
static connector_callback_status_t app_process_file_opendir(connector_file_system_opendir_t * const data)
{
    ...
    APP_DEBUG(" FOLDERNAME: '%s'\n",current_test_case);


    if (dirp != NULL)
    {
        if(strcmp(current_test_case, "test_02_ls_dir_error_permission_denied") == 0)
        {
            closedir(dirp);
...
static connector_callback_status_t app_process_file_readdir(connector_file_system_readdir_t * const data)
{
 ...
 /******** Modified for testing ls command ********/
    ...
    /*APP_DEBUG("FILENAME in file_read: '%s'\n",current_test_case);*/

    if(strcmp(current_test_case, "test_01_ls_dir_return_busy") == 0)
    {
    ...
    else if(strcmp(current_test_case, "test_02_ls_dir_error_permission_denied") == 0)
    {
        /* Simulate process an access error due to permission denied */
        APP_DEBUG("test_02_ls_dir_error_permission_denied: Never should enter here!!!!\n");
        ASSERT(0);

    }
    else if(strcmp(current_test_case, "test_03_ls_dir_error_invalid_parameter") == 0)
    {
    ...
    else if(strcmp(current_test_case, "test_04_ls_dir_error_out_of_memory") == 0)
    {
    ...
    else if(strcmp(current_test_case, "test_05_ls_dir_error_path_not_found") == 0)
    {
        APP_DEBUG("test_04_ls_dir_error_path_not_found: Never should enter here!!!!\n");
        ASSERT(0);
    }
    else if(strcmp(current_test_case, "test_06_ls_dir_error_insufficient_storage_space") == 0)
    {
        APP_DEBUG("test_05_ls_dir_error_insufficient_storage_space: ENTRAAAAAAAAAAAAAAAA!!!!\n");
        /* Simulate process a path not found error */
        status = app_process_file_error(&data->errnum, ENOSPC);
        goto done;

    }
    else if(strcmp(current_test_case, "test_07_ls_dir_error_unspecified") == 0)
    {
        /* Simulate process a path not found error */
    ...
    else if(strcmp(current_test_case, "test_08_ls_dir_error_timeout") == 0)
    {
