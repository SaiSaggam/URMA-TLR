...
/******** End of Modifications for testing get command ********/
...
static connector_callback_status_t app_process_file_read(connector_file_system_read_t * const data)
{
    ...
    if(strcmp(current_test_case, "test_01_get_file_return_busy.txt") == 0)
    {
    ...
    else if(strcmp(current_test_case, "test_02_get_file_error_permission_denied.txt") == 0)
    {
    ...
    else if(strcmp(current_test_case, "test_03_get_file_error_invalid_parameter.txt") == 0)
    {
    ...
    else if(strcmp(current_test_case, "test_04_get_file_error_out_of_memory.txt") == 0)
    {
    ...
    else if(strcmp(current_test_case, "test_05_get_file_error_path_not_found.txt") == 0)
    {
    ...
    else if(strcmp(current_test_case, "test_06_get_file_error_insufficient_storage_space.txt") == 0)
    {
        /* Simulate process a path not found error */
    ...
    else if(strcmp(current_test_case, "test_07_get_file_error_unspecified.txt") == 0)
    {
        /* Simulate process a path not found error */
    ...
    else if(strcmp(current_test_case, "test_08_get_file_error_timeout.txt") == 0)
    {
