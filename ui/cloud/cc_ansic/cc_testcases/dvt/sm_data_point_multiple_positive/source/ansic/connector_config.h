...
#define CONNECTOR_SM_UDP_RX_TIMEOUT        120  /* In seconds, SM_WAIT_FOREVER: Wait forever for the complete request/response */
#define CONNECTOR_SM_TX_TIMEOUT CONNECTOR_SM_UDP_RX_TIMEOUT /* Use same timeout as for RX */
