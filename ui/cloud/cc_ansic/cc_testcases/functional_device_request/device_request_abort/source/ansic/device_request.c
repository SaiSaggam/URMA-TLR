...
static char const device_request_target[] = "abort response";
...
static connector_callback_status_t app_process_device_request_target(connector_data_service_receive_target_t * const target_data)
{
    ...
    {
        /* Return abort for test test_01_send_abort_response_target */
        APP_DEBUG("app_process_device_request_target: return connector_callback_abort\n");
