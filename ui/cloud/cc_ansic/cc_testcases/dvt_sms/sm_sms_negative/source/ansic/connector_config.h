...
#define CONNECTOR_SM_SMS_MAX_SESSIONS   32
#define CONNECTOR_SM_SMS_RX_TIMEOUT        450  /* In seconds, SM_WAIT_FOREVER: Wait forever for the complete request/response */
#define CONNECTOR_SM_TX_TIMEOUT CONNECTOR_SM_SMS_RX_TIMEOUT /* Use same timeout as for RX */
...
#define CONNECTOR_SM_SMS_MAX_RX_SEGMENTS    1
#endif
