...
class DataPointPositiveTestCase(cc_testcase.TestCase):
    ...
    def test_dp1_sms_int(self):
        """ Validate dp_sms_int stream """
        self.verify_dp_file("dp_sms_int")
    ...
    def test_dp2_sms_long(self):
        """ Validate dp_sms_long stream """
        self.verify_dp_file("dp_sms_long")
    ...
    def test_dp3_sms_float(self):
        """ Validate dp_sms_float stream """
        self.verify_dp_file("dp_sms_float")
    ...
    def test_dp4_sms_double(self):
        """ Validate dp_sms_double stream """
        self.verify_dp_file("dp_sms_double")
    ...
    def test_dp5_sms_string(self):
        """ Validate dp_sms_string stream """
        self.verify_dp_file("dp_sms_string")
    ...
    def test_dp6_sms_binary(self):
        """ Validate dp_sms_binary stream """
        self.verify_dp_file("dp_sms_binary")
