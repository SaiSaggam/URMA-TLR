...
connector_bool_t device_provisioned = connector_false; /* Device already provisioned for SMS and can 
                                                          initiate actions */
...
connector_status_t app_send_data(connector_handle_t handle)
{
    ...
    static char const buffer[] = "Etherios sm sms dvt for device data\n";
...
connector_callback_status_t app_sm_handler(connector_request_id_sm_t const request, void * const data)
{
    ...
    switch (request)
    {
        ...
        case connector_request_id_sm_config_request:
        {
            ...
            device_provisioned = connector_true;
